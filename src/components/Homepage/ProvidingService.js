        ...
        <section className="bg-cover bg-center py-10" style={{ backgroundImage: "" }}>
            <div className="flex flex-col lg:flex-row justify-start gap-0 items-center w-11/12 lg:w-8/12 mx-auto ">
                ...
                <div className=" mt-12 lg:mt-0 lg:mr-4 grid flex flex-col  justify-start items-center gap-5">
                    <Card className="card w-full p-5 flex flex-col lg:flex-row justify-between items-center gap-3 lg:gap-5 card-body rounded-2xl dark:bg-white hover:bg-gradient-to-r from-secondary to-[#9cbafa] dark:from-tertiary dark:to-[#9CFAAC]">
                    ...
                    <Card className="card w-full p-5 flex flex-col lg:flex-row justify-between items-center gap-3 lg:gap-5 card-body rounded-2xl dark:bg-white hover:bg-gradient-to-r from-secondary to-[#9cbafa] dark:from-tertiary dark:to-[#9CFAAC] lg:ml-20">
                        <CardHeader className="m-0 p-0">
                            <Image
                                className="w-28 md:w-20 lg:w-20 md:h-20 lg:h-20"
                                src={ideaImg}
