            ...
            <div className="w-11/12 lg:w-8/12 mx-auto ">
                <div className="grid grid-cols-1  lg:grid-cols-3">
                    <div>
                        ...
                        <h3 className="font-bold mt-8 text-center lg:text-left text-4xl text-secondary dark:text-tertiary mb-20">
                            We Are Providing <br />
                            Digital Services
                        </h3>
                    </div>

                    <Card className="w-full lg:w-96 glass hover:bg-gradient-to-r from-secondary to-[#9cbafa] dark:from-tertiary dark:to-[#9CFAAC] dark:bg-white mb-5 shadow-md card">
                        <CardHeader>
